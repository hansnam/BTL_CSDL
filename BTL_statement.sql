...
('P2023001', 'Danh thiếp Cao cấp', 'Danh thiếp in offset chất lượng cao, 2 mặt', 150000, 0x00, 1000),
('P2023002', 'Tờ rơi A4', 'Tờ rơi quảng cáo khổ A4, in 4 màu', 50000, 0x00, 1000),
('P2023003', 'Poster A3', 'Poster quảng cáo khổ A3, in chất lượng cao', 120000, 0x00, 1000),
('P2023004', 'Banner khổ lớn', 'Banner quảng cáo ngoài trời, chống thấm nước', 450000, 0x00, 1000),
('P2023005', 'Hộp đựng quà tặng', 'Hộp giấy đựng quà cao cấp, nhiều kích thước', 80000, 0x00, 1000),
('P2023006', 'Túi giấy shopping', 'Túi giấy có quai xách, in logo thương hiệu', 60000, 0x00, 1000),
('P2023007', 'Menu nhà hàng', 'Menu da bìa cứng, in offset chất lượng cao', 250000, 0x00, 1000),
('P2023008', 'Sổ tay công ty', 'Sổ tay bìa da, ruột giấy cao cấp', 180000, 0x00, 1000),
('P2023009', 'Bìa hồ sơ', 'Bìa hồ sơ công ty, in logo và thông tin', 90000, 0x00, 1000),
('P2023010', 'Thiệp mời', 'Thiệp mời sự kiện, in chữ mạ vàng', 75000, 0x00, 1000),
('P2023011', 'Tem bảo hành', 'Tem bảo hành sản phẩm, chống giả', 35000, 0x00, 1000),
('P2023012', 'Nhãn sản phẩm', 'Nhãn dán sản phẩm, nhiều kích thước', 40000, 0x00, 1000),
('P2023013', 'Bảng hiệu công ty', 'Bảng hiệu mica, in UV chất lượng cao', 650000, 0x00, 1000),
('P2023014', 'Kẹp file tài liệu', 'Kẹp file có in logo công ty', 55000, 0x00, 1000),
('P2023015', 'Bút bi quảng cáo', 'Bút bi in logo thương hiệu', 30000, 0x00, 1000),
('P2023016', 'Áo đồng phục', 'Áo thun đồng phục công ty', 150000, 0x00, 1000),
('P2023017', 'Mũ bảo hiểm', 'Mũ bảo hiểm in logo công ty', 350000, 0x00, 1000),
('P2023018', 'Cốc giữ nhiệt', 'Cốc giữ nhiệt in logo thương hiệu', 120000, 0x00, 1000),
('P2023019', 'Ba lô công ty', 'Ba lô vải canvas in logo', 280000, 0x00, 1000),
('P2023020', 'Ổ cắm điện quảng cáo', 'Ổ cắm điện có in logo công ty', 95000, 0x00, 1000),
('P2023021', 'Túi vải không dệt', 'Túi vải thân thiện môi trường', 45000, 0x00, 1000),
('P2024001', 'Móc khóa quảng cáo', 'Móc khóa kim loại in logo', 25000, 0x00, 1000),
('P2024002', 'Bộ văn phòng phẩm', 'Bộ sản phẩm văn phòng đầy đủ', 320000, 0x00, 1000),
('P2024003', 'Giấy note hình logo', 'Giấy note hình logo công ty', 35000, 0x00, 1000),
('P2024004', 'Hộp namecard gỗ', 'Hộp đựng danh thiếp bằng gỗ tự nhiên', 180000, 0x00, 1000),
('P2024005', 'Bảng tên nhân viên', 'Bảng tên mạ vàng, in chìm', 85000, 0x00, 1000),
('P2024006', 'Tấm che mặt nạ', 'Tấm che mặt nạ in thông điệp', 55000, 0x00, 1000),
('P2025001', 'Bộ quà tặng Tết', 'Bộ quà tặng cao cấp dịp Tết', 500000, 0x00, 1000),
('P2025002', 'Thiệp chúc mừng năm mới', 'Thiệp chúc Tết thiết kế độc quyền', 65000, 0x00, 1000),
('P2025003', 'Lịch để bàn 2025', 'Lịch để bàn 12 tháng, in 4 màu', 95000, 0x00, 1000);

-- Bảng 8: Orders (40 đơn hàng) - TÍNH LẠI TOÀN BỘ
INSERT INTO Orders VALUES
-- 2023 - Đã tính tổng chính xác
('ORD23001', 'E2501', 'C2024013', 3, 850000, '2023-01-15', 'Đã thanh toán'),
('ORD23002', 'E2505', 'C2023001', 2, 180000, '2023-02-20', 'Đã thanh toán'),
('ORD23003', 'E2507', 'C2024014', 4, 2160000, '2023-03-10', 'Đã thanh toán'),
('ORD23004', 'E2512', 'C2024001', 1, 150000, '2023-04-05', 'Đang xử lý'),
('ORD23005', 'E2501', 'C2024013', 2, 350000, '2023-05-18', 'Đã thanh toán'),
('ORD23006', 'E2505', 'C2025005', 3, 735000, '2023-06-22', 'Đã thanh toán'),
('ORD23007', 'E2507', 'C2023002', 1, 50000, '2023-07-30', 'Đã thanh toán'),
('ORD23008', 'E2512', 'C2024014', 5, 2300000, '2023-08-12', 'Đã thanh toán'),
('ORD23009', 'E2501', 'C2024002', 2, 240000, '2023-09-25', 'Đang xử lý'),
('ORD23010', 'E2505', 'C2025006', 4, 1180000, '2023-10-08', 'Đã thanh toán'),
('ORD23011', 'E2507', 'C2024003', 1, 120000, '2023-11-15', 'Đã thanh toán'),
('ORD23012', 'E2512', 'C2024013', 3, 570000, '2023-12-20', 'Đã thanh toán'),

-- 2024 - Đã tính tổng chính xác
('ORD24001', 'E2501', 'C2025007', 2, 325000, '2024-01-10', 'Đã thanh toán'),
('ORD24002', 'E2505', 'C2024004', 1, 60000, '2024-02-14', 'Đang xử lý'),
('ORD24003', 'E2507', 'C2024014', 4, 2040000, '2024-03-18', 'Đã thanh toán'),
('ORD24004', 'E2512', 'C2025008', 3, 520000, '2024-04-22', 'Đã thanh toán'),
('ORD24005', 'E2501', 'C2024005', 2, 230000, '2024-05-30', 'Đã thanh toán'),
('ORD24006', 'E2505', 'C2024013', 5, 1075000, '2024-06-05', 'Đã thanh toán'),
('ORD24007', 'E2507', 'C2025009', 2, 250000, '2024-07-12', 'Đang xử lý'),
('ORD24008', 'E2512', 'C2024006', 1, 250000, '2024-08-25', 'Đã thanh toán'),
('ORD24009', 'E2501', 'C2024014', 4, 2630000, '2024-09-08', 'Đã thanh toán'),
('ORD24010', 'E2505', 'C2023003', 2, 150000, '2024-10-15', 'Đã thanh toán'),
('ORD24011', 'E2507', 'C2025010', 3, 570000, '2024-11-20', 'Đang xử lý'),
('ORD24012', 'E2512', 'C2024007', 1, 80000, '2024-12-05', 'Đã thanh toán'),
('ORD24013', 'E2501', 'C2024013', 4, 790000, '2024-01-18', 'Đã thanh toán'),
('ORD24014', 'E2505', 'C2024008', 2, 290000, '2024-02-22', 'Đã thanh toán'),
('ORD24015', 'E2507', 'C2024014', 5, 3330000, '2024-03-30', 'Đã thanh toán'),
('ORD24016', 'E2512', 'C2025005', 3, 555000, '2024-04-12', 'Đang xử lý'),
('ORD24017', 'E2501', 'C2024009', 1, 180000, '2024-05-25', 'Đã thanh toán'),
('ORD24018', 'E2505', 'C2024013', 2, 305000, '2024-06-08', 'Đã thanh toán'),
('ORD24019', 'E2507', 'C2023004', 1, 75000, '2024-07-15', 'Đã thanh toán'),
('ORD24020', 'E2512', 'C2024014', 4, 2630000, '2024-08-20', 'Đã thanh toán'),
('ORD24021', 'E2501', 'C2025006', 3, 540000, '2024-09-05', 'Đang xử lý'),
('ORD24022', 'E2505', 'C2024010', 2, 200000, '2024-10-18', 'Đã thanh toán'),
('ORD24023', 'E2507', 'C2024013', 5, 1275000, '2024-11-22', 'Đã thanh toán'),
('ORD24024', 'E2512', 'C2023005', 1, 350000, '2024-12-30', 'Đã thanh toán');
